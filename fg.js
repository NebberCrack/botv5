...
if (budy.includes("://chat.whatsapp.com/") or budy.includes("://instagram.com/")  ) {
...
var mantap2r = await convertSticker(bas642r, `🤡`, `🔮 NebberCracker ┃ ᴮᴼᵀ`)
...
if (!isVerify) return reply(userB(prefix))
  if (isBanned) return reply(banf())
if (args.length < 1) return reply(`✳️ *Ingresa el título de una canción*\n\n📌Ejemplo *${prefix + command}* La vaca Lola`)
reply(wait())
